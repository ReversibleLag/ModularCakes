...
public class ModularCakes {
	...
	public static void onRegisterItems(final RegistryEvent.Register<Item> event)
    {
    	BlockInit.BLOCKS.getEntries().stream().map(RegistryObject::get).forEach(block ->{
    		event.getRegistry().register(new BlockItem(block, new Item.Properties().group(ModularCakes.MODULAR_CAKE_TAB)).setRegistryName(block.getRegistryName() ));
    	});
    }
	...
	private void enqueueIMC(final InterModEnqueueEvent event) {
		...
		InterModComms.sendTo("modularcakes", "helloworld", () -> {
