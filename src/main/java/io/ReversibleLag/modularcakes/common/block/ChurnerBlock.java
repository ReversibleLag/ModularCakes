...
public class ChurnerBlock extends Block {
	...
	public ChurnerBlock() {
		super(AbstractBlock.Properties.create(Material.WOOD, MaterialColor.BROWN).sound(SoundType.WOOD).hardnessAndResistance(2f,2f));
